...
static int gpio_eos_s3_port_get_direction_bits_raw(const struct device *port,
...
static const struct gpio_driver_api gpio_eos_s3_driver_api = {
	...
	.port_get_direction_bits_raw = gpio_eos_s3_port_get_direction_bits_raw,
};
